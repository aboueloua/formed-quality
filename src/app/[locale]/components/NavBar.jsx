...
const NavBar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-10 bg-cyan-500 bg-opacity-100 text-white">
        ...
        <div className="mobile-menu block md:hidden">
          {!navbarOpen ? (
            <button
              ...
              className="flex items-center px-3 py-2 border rounded border-slate-200 text-white hover:text-cyan-300 hover:border-cyan-300"
            >
